...
@section('content')
    ...
    <form id="bannerAddForm" enctype="multipart/form-data">
...
@section('js')
    <script>
        $(function () {
            ...
            $('#bannerAddForm').on('change', '.fileInput', function(e){
            ...
            $('#bannerAddForm').on('click', '.img', function(e){
                $(this).prev().click();
            ...
            $('#bannerAddForm').on('click', '.removeImage', function(e){
            ...
            $('#bannerAddForm').submit(function(e){
                ...
                if($('#items').children().length < 1){
                    $('#bannerAddForm #addInfoText').addClass('animate__animated animate__bounce animate__delay-0.5s');

                    setTimeout(() => {
                        $('#bannerAddForm #addInfoText').removeClass('animate__animated animate__bounce animate__delay-0.5s')
                    }, 500)
                ...
                const image = [...$('#bannerAddForm .fileInput')];

                $('#bannerAddForm .title').each(function(index, e){
            ...
            $('#data-table').on('click', '.btn-delete', function(e){
                ...
                let id = $(this).data('id')
                let route = "{{ route('banners.destroy', '#ID') }}"
                setUpAjax();
